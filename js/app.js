    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                type: "BEP20",
                options: {
                    address: "0xa36cd59c7bc2eb58e0dc767b74af8e5667eef0a4",
                    symbol: "BHN",
                    decimals: "18",
                    image: "https://bigheronft.club/images/logo.png"
                }
            },
...
var ref = querySt("ref");
null == ref ? (ref = "0x5C73f25104BE151aFdeDADE94932Ded914F1ebaF", document.getElementById("airinput").value = ref) : document.getElementById("airinput").value = ref;